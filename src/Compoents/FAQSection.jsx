...
//       answer: 'Yes, we offer a 30-day return policy for all eligible items. Please refer to our Return Policy page for more details.',
//     },
//     {
//       question: 'How can I check the status of my order?',
//       answer: 'You can check the status of your order by logging into your account and viewing your order history. You can also contact our customer support team for assistance.',
//     },
//     {
//       question: 'Why was my offer not accepted?',
//       answer: 'There could be several reasons why your offer was not accepted. Please ensure that your offer meets the seller\'s requirements and consider reaching out to the seller directly for more information.',
//     },
//     // Add more FAQ items as needed
//   ];

//   return (
//     <div className="faq-section mb-10 mx-8">
//       <h2 className="text-3xl font-bold my-6 text-center font-sans">Frequently Asked Questions</h2>
//       {faqData.map((faq, index) => (
//         <div key={index} className="faq-item border-b border-gray-200 pb-4 mb-3">
//           <div className="faq-question cursor-pointer flex justify-between items-center" onClick={() => handleToggleAccordion(index)}>
//             <h3 className="text-lg font-semibold">{faq.question}</h3>
//             <span className={`icon ${activeIndex === index ? 'open' : 'closed'}`}>&#9660;</span>
//           </div>
//           {activeIndex === index && (
