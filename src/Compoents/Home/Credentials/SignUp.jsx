...
//             style={{
//               backgroundImage: `url(${"https://i.ibb.co/gm95zsP/cytonn-photography-TVyh-Dpv-L8-MY-unsplash.jpg"})`,
//             }}
//           ></div>

//           <div className="w-full px-6 py-3 md:px-8 lg:w-1/2 bg-orange-300">
//             <div className="flex justify-center mx-auto">
//               <img
//                 className="w-auto h-10 sm:h-8 rounded-full"
...
const SignUp = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      await updateUserProfile(name, image_url); // Pass name and image_url directly
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Step 3: Send user info to the backend
      const res = await axiosPublic.post("/users", userInfo);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sign Up to your EstateElite account."
        />
      </Helmet>
      <div className="flex justify-center items-center min-h-[calc(100vh-306px)] my-12">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
