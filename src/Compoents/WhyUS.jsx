...
//         <h1 className="text-3xl font-extrabold text-center mb-12 font-sans">Why Choose Us ?</h1>
//       <div className="grid gap-14 md:grid-cols-3 md:gap-5">
//         <div className="rounded-xl border bg-inherit p-6 text-center shadow-xl">
...
//             Explore the world your way with our personalized tour packages. From
//             adventurous escapades to cultural immersions, we tailor every
//             itinerary to your preferences for an unforgettable travel
//             experience.
//           </p>
//         </div>
...
//           </h1>
//           <p className="px-4 text-gray-500">
//             Description 2: Enjoy hassle-free booking with our intuitive
//             platform. Discover and reserve flights, accommodations, and
//             activities seamlessly, ensuring a smooth and stress-free journey
...
//           </h1>
//           <p className="px-4 text-gray-500">
//             Let our seasoned travel experts guide you to hidden gems and
//             must-see attractions. With insider knowledge and local insights, we
//             ensure every aspect of your trip is curated to perfection, making
    ...
    <div className="h-full min-h-screen w-full bg-inherit pt-10 p-4">
      ...
      <div className="grid gap-14 md:grid-cols-3 md:gap-5">
        <div className="rounded-xl border bg-slate-100 p-6 text-center shadow-xl">
          ...
          <p className="px-4 text-gray-500">
            Leverage our years of experience and local expertise to find the perfect property. Our agents provide personalized advice and insights, ensuring you make the best investment decisions.
          </p>
        </div>
        ...
        >
          ...
          <p className="px-4 text-gray-500">
            Access an extensive database of properties across various locations. Whether youre looking for a cozy apartment or a luxurious villa, we have listings to suit every taste and budget.
          </p>
        </div>
      </div>
    </div>
